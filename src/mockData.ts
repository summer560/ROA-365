...
export const quickMenus = ['상품 검색', '행사 상품', '비상용품 재고', '세이프존 현황', 'ROA 제휴 서비스', '매장 이용 안내', '3개월 채용 공고'];

export const quickMenuDetails: Record<string, string> = {
  '상품 검색': '카테고리, 가격대, 재고 상태로 상품을 빠르게 조회할 수 있는 메뉴입니다.',
  '행사 상품': '당일/주간 행사 대상 상품과 적용 시간대를 확인할 수 있습니다.',
  '비상용품 재고': '마스크, 보온 담요, 정화수 등 비상용품의 실시간 재고 현황을 제공합니다.',
  '세이프존 현황': '세이프존 수용 인원, 운영 단계, 대피 동선을 안내합니다.',
  'ROA 제휴 서비스': 'ROA 인증 고객 대상 배터리 교환, 픽업, 보고 접수 서비스를 안내합니다.',
