...
export const alertMessages = [
  ...
  '성인 제한 재난 활성 구역은 미성년자 출입이 법적으로 금지됩니다.',
  'ROA 호출기 배터리팩 일부 품목 재고 부족',
];

export const quickMenus = ['상품 검색', '행사 상품', '비상용품 재고', '세이프존 현황', 'ROA 제휴 서비스', '매장 이용 안내', '3개월 채용 공고', '고객 문의'];
export const dashboard = [
  ['영업 상태', '정상 운영'], ['포탈 경보', '관심 (1단계)'], ['세이프존 수용 가능 인원', '42명'], ['비상 키트 재고', '충분'],
  ['ROA 제휴 카운터', '운영 중'], ['호출기 충전 독', '9/12 사용 가능'], ['성인 제한 재난 구역', '인근 활성 없음'], ['미성년자 출입 제한 공지', '정상'],
];
...
export const products: Product[] = [
  ...
  { name: '단기 대피용 보온 담요', price: '₩4,900', stock: '충분', category: '세이프존 소모품', description: '세이프존 이용객 권장 물품.' },
  { name: '외계 독성 차단 마스크', price: '₩9,500', stock: '보통', category: '포탈 재난 대비용품', description: '등급 1~2 생활형 위험 대응.' },
  { name: '오염 의류 임시 밀봉백', price: '₩3,900', stock: '충분', category: '세이프존 소모품', description: '접촉성 오염 의심 물품 분리 보관.' },
  { name: 'ROA 인증 회복 젤', price: '₩5,700', stock: '한정', category: '레인저 제휴 상품', description: '앱 인증 고객 구매 가능.' },
];
...
export const events: EventItem[] = [
  ...
  { title: '세이프존 담요 구매 시 정화수 할인', period: '포탈 경보 주의 이상', detail: '안전 물품 동시 구매 혜택.' },
  { title: '호출기 배터리팩 입고 알림 신청', period: '상시', detail: '재입고 시 앱 푸시 알림.', note: '대피는 무료, 소모품은 합리적인 가격으로 제공합니다.' },
];

export const notices = ['일온시 포탈 경보 관심 단계 유지 안내', '비상 호출기 배터리팩 일부 품목 재입고 지연', '세이프존 정기 점검 일정 안내', '미성년자 출입 제한 구역 관련 보호자 안내', '이상현상 의심 상품 신고 절차 안내', '외인혼혈 3개월 기간제 스태프 채용 공고'];
export const faqs = [
  ...
  ['미성년자도 세이프존에 들어갈 수 있나요?', '일반 포탈 경보 상황에서는 대피가 가능하나 성인 제한 재난 활성 구역은 법적으로 미성년자 출입이 금지됩니다.'],
  ['외인혼혈 채용은 어떤 제도인가요?', '본사 세이프존 인력 지원 프로그램에 따른 3개월 기간제 시범 고용 트랙입니다.'],
  ['이상현상을 발견하면 어떻게 해야 하나요?', '직원에게 알리거나 이상현상 신고 QR을 이용해 접수해 주세요.'],
];

export const safezoneFacilities = ['강화 방호 셔터', '간이 방호벽', '응급 키트', '외계 독성 차단 마스크', '정화수 보관함', '비상식량 보관함', '비상 호출기 충전 독', 'ROA 직통 신고 버튼', '이상현상 신고 태블릿', '미성년자 보호 안내 표지'];
